 ...
 * incompatible version. This file can be used for manual configuration will not
 * be modified if the flowDefaults constant exists.
 */
...
/**
 * This file can be used to configure the flow plugin defaults. <code>
 *   // Add a custom plugin
 ...
 * </code>
 * or add new configuration in the merge block. <code>
 *   module.exports = merge(flowDefaults, {
 *     mode: 'development',
